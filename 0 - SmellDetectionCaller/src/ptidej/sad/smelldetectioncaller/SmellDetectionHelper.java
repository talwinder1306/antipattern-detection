...
public final class SmellDetectionHelper {
	...
	//			"SpaghettiCode" };
	public static final String[] SMELLS = new String[] { "LavaFlow" };
		...
		try {
			for (int i = 0; i < someSmells.length; i++) {
				...
				try {
					...
					detectionClass = Class.forName("ptidej.sad.designsmell.detection.repository.LavaFlowDetection");
					//Class.forName("ptidej.sad.smelldetectioncaller.SmellDetectionHelper");
				}
